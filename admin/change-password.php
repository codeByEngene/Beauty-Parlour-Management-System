...
<head>
    ...
    <style>
        .main-content { padding: 40px; margin-left: 300px; }
    ...
    <div class="settings-card">
        ...
        <form method="post" name="changepassword" onsubmit="return validateFinal();">
            ...
            <div class="form-group">
                ...
                <input type="password" name="currentpassword" id="current" class="form-control" placeholder="Enter current password" required>
                <i class="fa fa-eye toggle-password" onclick="togglePass('current', this)"></i>
            </div>

            <div class="form-group">
                <label>New Password</label>
                <input type="password" name="newpassword" id="newpass" class="form-control" placeholder="Enter new password" required onkeyup="checkMatch()">
                <i class="fa fa-eye toggle-password" onclick="togglePass('newpass', this)"></i>
            </div>

            <div class="form-group">
                <label>Confirm New Password</label>
                <input type="password" name="confirmpassword" id="confirmpass" class="form-control" placeholder="Confirm new password" required onkeyup="checkMatch()">
