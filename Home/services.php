...
<body>
  ...
  <main class="service-grid">
    ...
    <div class="service-card">
      <img src="images/Eyebrow Threading.jpg" alt="Eyebrow Threading">
      <h2>Eyebrow Threading</h2>
      <p>Get perfectly shaped eyebrows with our professional threading service.</p>
      <p class="price">Cost of Service: Rs.200</p>
      <a href="login.php" class="btn">Get Appointment</a>
